...
void RandoSaveCheck_to_json(nlohmann::json& j, const RandoSaveCheck& randoSaveCheck) {
    j = nlohmann::json::array({ randoSaveCheck.randoCheckId, randoSaveCheck.randoItemId, randoSaveCheck.isShuffled,
                                randoSaveCheck.eligible, randoSaveCheck.received, randoSaveCheck.skipped });
}
...
RandoSaveCheck RandoSaveCheck_from_json(const nlohmann::json& j, RandoSaveCheck& randoSaveCheck) {
    ...
    j.at(2).get_to(randoSaveCheck.isShuffled);
    j.at(3).get_to(randoSaveCheck.eligible);
    j.at(4).get_to(randoSaveCheck.received);
