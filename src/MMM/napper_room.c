...
void func_8038966C(void){
    ...
    if( !MMM_D_8038C4E0.unk2
        ...
        func_80324DBC(0.2f, VER_SELECT(ASSET_AD9_DIALOG_NAPPER_COMPLETE, 0x94B, 0, 0), 6, NULL, NULL, func_803895D8, NULL);
    }//L80389700
    ...
    if(tmp_v0 != NULL){
        if((s32)(tmp_v0->flags << 4) < 0){
            ...
            if (!levelSpecificFlags_get(LEVEL_FLAG_1B_MMM_UNKNOWN)) {
                ...
                func_80324DBC(0.0f, VER_SELECT(ASSET_AD7_DIALOG_NAPPER_AWAKE, 0x949, 0, 0), 6, NULL, NULL, func_803895D8, NULL);
