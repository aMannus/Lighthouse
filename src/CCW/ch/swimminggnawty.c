...
CH_GNAWTY_SWIMMING_DIALOG chGnawtySwimmingDialogs[] ={
    {MAP_43_CCW_SPRING, FALSE, VER_SELECT(ASSET_CCE_DIALOG_GNAWTY_MEET_SPRING, 0x09E3, 0, 0)},
    {MAP_45_CCW_AUTUMN,  TRUE, VER_SELECT(ASSET_CD1_DIALOG_GNAWTY_MEET_FALL_OUTSIDE, 0x09E6, 0, 0)},
    {MAP_46_CCW_WINTER,  TRUE, VER_SELECT(ASSET_CD3_DIALOG_GNAWTY_MEET_WINTER_OUTSIDE, 0x09E8, 0, 0)},
