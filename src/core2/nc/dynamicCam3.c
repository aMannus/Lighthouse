...
void ncDynamicCam3_update(void) {
    ...
    sp3C = sqrtf(sp40[0]*sp40[0] + sp40[2]*sp40[2]);
    sp3C += ml_clamp_abs_f(sp30*(sp34 - sp3C)*2 , sp30 * 800.0f);
    ml_horizontal_and_vertical_angles(sp7C[0], sp7C[1], sp7C[2], sp64[0], sp64[1], sp64[2], &sp4C[0], &sp4C[1]);
    sp40[1] = sp30 * 0.77 * mlDiffDegF(mlNormalizeAngle(player_getYaw() + 180.0f), sp4C[1]);
    sp40[1] = ml_clamp_abs_f(sp40[1], sp30 * 300.0f);
