...
s16 D_8036506C[] = {   0,            -1,    0,  0xC,  0xD,  0xD, 0x28,  0x3, 0x46, -6, -1, 0x4B};
s16 D_80365084[] = {   0,            -1,    0,    0, 0x13,    1, 0x38,  0xD,           -4, 0x65};
s16 D_80365098[] = {   0,            -1,    0,    6,  0xD,    7, 0x28, 0x14,           -4, 0x49};
s16 D_803650AC[] = {   0,            -1,    0,    2,  0xD,    3, 0x28,  0xB,           -4, 0x49};
s16 D_803650C0[] = {   0,            -1,    0,    0,  0xD,    1, 0x26,  0xC,           -4, 0x48};
s16 D_803650D4[] = {   0,            -1,    0,    3,  0xD,    4, 0x26, 0x13,           -4, 0x48};
s16 D_803650E8[] = {   0,            -1,    0,    0,  0xD,    1, 0x26,  0x4,           -4, 0x48};
s16 D_803650FC[] = {   0,            -1,    0,    0,  0xD,    1, 0x26,  0xD,           -4, 0x50};
s16 D_80365110[] = {   0,            -1,    0,    3,  0xD,    4, 0x26, 0x20,           -4, 0x48};
#endif
